...
const uint8_t pids[] ={cntlslv0, cntlslv1, cntlslv2, cntlslv3,stslv0, stslv1};
const uint8_t messagebytes[] ={2, 1, 6, 2, 3, 2};


const uint8_t sources[] ={master, master, master, master, slave0, slave0};
const uint8_t destinations[] ={slave0, slave0, slave0, slave0, master, master};
